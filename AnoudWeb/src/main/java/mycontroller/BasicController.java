...
public class BasicController {
	...
	@RequestMapping(method = RequestMethod.GET, value = "/hello4/{myp}/{myf}")
	public void sayHello3(@PathVariable("myp") String mypath,@PathVariable("myf") String myfriend) {
		System.out.println("say hello method...."+mypath+":"+myfriend);
	}
